        ...
        <div className='mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8'>
          ...
          <div className='grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
            {Array.from({ length: 8 }).map((_, index) => (
              <div
                key={index}
                className='overflow-hidden rounded-3xl bg-gray-200 shadow-sm'
              >
    ...
    <div className='flex min-h-[42vh] items-center justify-center rounded-2xl bg-white px-5 py-16 text-center'>
      <div className='max-w-md'>
        <div className='mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-[1.8rem] bg-orange-50 text-orange-500'>
          ...
          >
            <path
              d='M27 38h66v52a6 6 0 0 1-6 6H33a6 6 0 0 1-6-6V38Z'
              fill='#FFF4E5'
              stroke='currentColor'
              strokeWidth='5'
            />
            <path
              d='M43 38c0-10 7-18 17-18s17 8 17 18'
              stroke='currentColor'
              strokeWidth='5'
              strokeLinecap='round'
            />
            <path
              d='M43 61h34M43 75h22'
              stroke='currentColor'
              strokeWidth='5'
              strokeLinecap='round'
            />
      ...
      <div className='max-w-md'>
        <div className='mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-[1.5rem] bg-orange-50 text-orange-500'>
          ...
          >
            ...
            />
            <path
              d='m31 76 18-18 13 13 10-10 18 18'
              stroke='currentColor'
              strokeWidth='5'
              strokeLinecap='round'
              strokeLinejoin='round'
        ...
        <p className='mt-3 text-sm leading-6 text-slate-500'>
          Les images et vidéos des annonces de cet annonceur apparaîtront ici.
        </p>
      </div>
    </div>
  );
