...
export default function Nav(): React.ReactElement {
  ...
  return (
    <>
            ...
            <div className='flex gap-6 md:gap-28 '>
              ...
              >
                <div className="w-8 h-8 flex flex-col justify-center items-center">
                  <span
                    className={`block w-6 h-0.5 bg-white rounded-full transition-all duration-300 ease-in-out ${isMenuOpen ? 'transform rotate-45 translate-y-1.5' : ''
                      }`}
                  ></span>
                  <span
                    className={`block w-6 h-0.5 bg-white rounded-full my-1.5 transition-all duration-300 ease-in-out ${isMenuOpen ? 'opacity-0 transform scale-x-0' : ''
                      }`}
                  ></span>
                  <span
                    className={`block w-6 h-0.5 bg-white rounded-full transition-all duration-300 ease-in-out ${isMenuOpen ? 'transform -rotate-45 -translate-y-1.5' : ''
      ...
      <div
        className={`fixed inset-0 bg-[#EA7D00]/90 z-[10] flex flex-col items-center justify-center transition-all duration-500 ease-in-out ${isMenuOpen
