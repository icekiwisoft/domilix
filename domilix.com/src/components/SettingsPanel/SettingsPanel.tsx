...
export default function SettingsPanel({
  ...
  const handleBuyPack = () => {
    try {
      ...
      alert("Erreur lors de l'ouverture des packs");
    }
  };
  ...
  const settingsPanel = (
    ...
    >
      <aside
        className={
          variant === 'page'
            ? 'hidden rounded-3xl border border-gray-200 bg-white p-5 text-gray-900 shadow-sm lg:sticky lg:top-24 lg:block lg:h-fit'
      ...
      >
          ...
          {/* Horizontal Tabs */}
          <div className={variant === 'page' ? 'flex-shrink-0 border-b border-gray-100 bg-gray-50/80 lg:hidden' : 'flex-shrink-0 border-b border-gray-100 bg-gray-50/80 md:hidden'}>
